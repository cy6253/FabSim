...
- [물리 현상 검토](fabsim3d-physics-review.md) — 연산자 12종 모델 재점검. 확인된 결함 3건(LOCOS 마스크 위 산화막 캡·x0=0·미사용 속도표), 개선 9건, 범위 밖 5건. Opus 5 구현 지시서
- [M4·M5 교육 계층과 마무리](fabsim3d-m4.md) — 진단·측정, 마스크 디자이너, 표 편집, 영속화, 배포. 로드맵 완료
- [완성 직전 전체 검토](fabsim3d-improvement-review.md) — 64개 파일 재검토. 개선 22건(메시→워커, 진행 표시, 격자 상한, 진단 거짓 경고, 표 편집기 확장 …)과 하지 말 것 5건. 기준선 수치 포함. Opus 구현 지시서
