...
> **2026-09-04 정정 — 이 제약은 M1·M2 시점의 PC 이야기다.** 저장소를 clone한 현재 PC에는
> Node v24가 있고, M3부터는 실제 빌드로 진행한다. 그때 작성된 브라우저 JS는 나중에 Node로
> 실행해 14/14 통과를 확인했다. 자세한 내용은 [[fabsim3d-m3]].
